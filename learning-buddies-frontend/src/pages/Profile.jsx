...
export default function Profile() {
  ...
  return (
    <main className="relative mb-5 w-full px-2 pt-2 font-raleway text-dark md:mx-auto md:flex md:max-w-7xl md:gap-x-4 dark:text-light">
      ...
      <section className="mt-10 px-3 md:mt-0 md:h-fit md:w-1/3 md:rounded-md md:bg-white md:p-6 lg:mx-auto lg:w-1/2 lg:max-w-5xl lg:px-10 md:dark:bg-dm-dark-green">
        ...
        <h2 className="pt-2 text-2xl font-bold">Tus solicitudes pendientes</h2>
        <div className="my-4 flex flex-col gap-4">
