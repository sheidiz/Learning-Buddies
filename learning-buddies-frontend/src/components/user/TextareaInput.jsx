export const TextareaInput = ({ label, inputName, inputPlaceholder, className, required }) => {
    return (
        <div className={`${className} w-full`}>
            <label htmlFor={inputName} className="w-full font-semibold">{label}</label>
            <textarea name={inputName} id={inputName} placeholder={inputPlaceholder} required={required}
